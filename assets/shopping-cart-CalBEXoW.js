import{c as a,d,e as m,i as p,f}from"./scrollToTop-DjrDOgE4.js";document.addEventListener("DOMContentLoaded",()=>{const s=document.getElementById("cart-items-container"),c=document.getElementById("cart-total-amount");if(!s)return;function n(){const o=d();let r=0;s.innerHTML="",o.forEach((t,i)=>{const e=document.createElement("div");e.classList.add("cart-item"),e.innerHTML=`
